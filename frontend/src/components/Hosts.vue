...
<template>
    <div>
        <h2 class="font-bold pl-3 pt-3">Hosts</h2>
                                ...
                                <tr v-for="(host,idx) in searchByHostname" :key="idx" class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        <div class="text-sm font-normal text-gray-500">
                                            <div class="text-base font-semibold text-gray-900">{{ idx }}</div>
                                    ...
                                    <td class="p-4 whitespace-nowrap space-x-2">
                                        ...
                                        <div @click="this.hostIndex = idx; this.deleteModal = true;" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
            ...
            <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                ...
                <div class="bg-white rounded-lg shadow relative">
                    ...
                    <div class="flex items-start justify-between p-5 border-b rounded-t">
                        ...
                        <div @click="this.editModal=false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="host-modal">
        ...
        <!-- Add Host Modal -->
        <div v-show="addModal" class="overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full flex" id="add-host-modal">
            <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
            <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                <!-- Modal content -->
                <div class="bg-white rounded-lg shadow relative">
                    ...
                    <div class="flex items-start justify-between p-5 border-b rounded-t">
                        ...
                        <div @click="this.addModal=false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="add-host-modal">
                            <i class="fas fa-times"></i>
                        </div>
                    </div>
                    <!-- Modal body -->
                    <div class="p-6 space-y-6">
                        ...
                        <!-- Modal footer -->
                        <div class="items-center p-6 border-t border-gray-200 rounded-b">
                            <button class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Add host</button>
                        </div>
                </div>
            </div>
        </div>
        ...
        <!-- Delete Host Modal -->
        <div v-show="deleteModal" class="overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full flex" id="delete-host-modal">
            <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
            <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                ...
                <div class="bg-white rounded-lg shadow relative">
                    ...
                    <div class="flex justify-end p-2">
                        <div @click="this.deleteModal=false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="delete-host-modal">
                            <i class="fas fa-times"></i>
                        </div>
                    </div>
                    <!-- Modal body -->
                    <div class="p-6 pt-0 text-center">
                        ...
                        <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Are you sure you want to delete this host?</h3>
                        ...
                        <a href="#" class="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-blue-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center" data-modal-toggle="delete-host-modal">
                            No, cancel
                        </a>
                    </div>
                </div>
